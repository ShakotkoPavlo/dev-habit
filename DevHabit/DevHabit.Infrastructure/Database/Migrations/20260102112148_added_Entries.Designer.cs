...
namespace DevHabit.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260102112148_added_Entries")]
    partial class added_Entries
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevHabit.Domain.Entities.Entry", b =>
                {
            ...
            modelBuilder.Entity("DevHabit.Domain.Entities.GitHubAccessToken", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
            ...
            modelBuilder.Entity("DevHabit.Domain.Entities.Habit", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
            ...
            modelBuilder.Entity("DevHabit.Domain.Entities.HabitTag", b =>
                {
                    b.Property<string>("HabitId")
                        .HasColumnType("character varying(500)")
                        .HasColumnName("habit_id");
                    ...
                    b.HasIndex("HabitId", "TagId")
                        .HasDatabaseName("ix_habit_tags_habit_id_tag_id");

                    b.ToTable("habit_tags", "dev_habit");
                });

            modelBuilder.Entity("DevHabit.Domain.Entities.Tag", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
            ...
            modelBuilder.Entity("DevHabit.Domain.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
            ...
            modelBuilder.Entity("DevHabit.Domain.Entities.Entry", b =>
                {
                    b.HasOne("DevHabit.Domain.Entities.Habit", "Habit")
                        .WithMany()
                    ...
                    b.HasOne("DevHabit.Domain.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DevHabit.Domain.Entities.GitHubAccessToken", b =>
                {
                    b.HasOne("DevHabit.Domain.Entities.User", null)
                        .WithOne()
                        .HasForeignKey("DevHabit.Domain.Entities.GitHubAccessToken", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("DevHabit.Domain.Entities.Habit", b =>
                {
                    ...
                    b.OwnsOne("DevHabit.Domain.Entities.Frequency", "Frequency", b1 =>
                        {
                    ...
                    b.OwnsOne("DevHabit.Domain.Entities.Milestone", "Milestone", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("DevHabit.Domain.Entities.Target", "Target", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("DevHabit.Domain.Entities.HabitTag", b =>
                {
                    b.HasOne("DevHabit.Domain.Entities.Habit", null)
                        .WithMany("HabitTags")
                        .HasForeignKey("HabitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                    ...
                    b.HasOne("DevHabit.Domain.Entities.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
