...
namespace DevHabit.Infrastructure.Database.Migrations
{
    ...
    [Migration("20251208142027_added_habittags")]
    partial class added_habittags
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevHabit.Domain.Habits.Entities.Habit", b =>
                {
            ...
            modelBuilder.Entity("DevHabit.Domain.Habits.Entities.HabitTag", b =>
                {
            ...
            modelBuilder.Entity("DevHabit.Domain.Habits.Entities.Tag", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
            ...
            modelBuilder.Entity("DevHabit.Domain.Habits.Entities.Habit", b =>
                {
                    b.OwnsOne("DevHabit.Domain.Habits.Entities.Frequency", "Frequency", b1 =>
                        {
                    ...
                    b.OwnsOne("DevHabit.Domain.Habits.Entities.Milestone", "Milestone", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("DevHabit.Domain.Habits.Entities.Target", "Target", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("DevHabit.Domain.Habits.Entities.HabitTag", b =>
                {
                    b.HasOne("DevHabit.Domain.Habits.Entities.Habit", null)
                        .WithMany("HabitTags")
                        .HasForeignKey("HabitId")
                    ...
                    b.HasOne("DevHabit.Domain.Habits.Entities.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
